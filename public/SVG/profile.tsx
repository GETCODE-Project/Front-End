...
// 임시 프로필(댓글용)
export const Profile2SVG = ({size}:any) =>(           
<svg width={String(size)} height={String(size)} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="0.5" y="0.5" width="29" height="29" rx="14.5" fill="#FF993A" stroke="#FF993A"/>
<path d="M7 22C7 19.1875 10.75 19.1875 12.625 17.3125C13.5625 16.375 10.75 16.375 10.75 11.6875C10.75 8.56281 11.9997 7 14.5 7C17.0003 7 18.25 8.56281 18.25 11.6875C18.25 16.375 15.4375 16.375 16.375 17.3125C18.25 19.1875 22 19.1875 22 22" stroke="white" stroke-width="2" stroke-linecap="round"/>
</svg>
