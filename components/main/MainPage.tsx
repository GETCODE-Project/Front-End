      ...
      <Layout>
        <TopContents>
          <Contents>
            ...
            <MoreViewButton href="/project">더보기</MoreViewButton>
        ...
        <BottomContents>
          <Title>
            <span onClick={() => setPageName("/project")}>프로젝트 |</span>
            <span onClick={() => setPageName("/findProject")}>
              프로젝트 모집 |
            </span>
            <span onClick={() => setPageName("/findStudy")}>스터디 모집</span>
          </Title>
          <MoreViewButton href={pageName}>더보기</MoreViewButton>
          <ObjectWrapper>
