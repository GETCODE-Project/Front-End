...
// 다중 선택 토글 폼
/** ------------------------------------------------------------- */
export const MultiToggle = ({data, currentSelected, setCurrentSelected, selectedAll, setSelectedAll}:Props) => {
...
// 단일 선택 토글 폼
/** ------------------------------------------------------------- */
export const SingleToggle = ({data, currentSelected, setCurrentSelected}:Props) => {
